...
class BotEvadeEnv(Environment):
    ...
    def __update_observation__(self):
        if self.observation_type == BotEvadeEnv.ObservationType.DATA:
            ...
            self.observation.prey_visible = self.model.prey_data.prey_visible
    ...
    def __step__(self):
        ...
        if self.observation_type == BotEvadeEnv.ObservationType.DATA:
            self.predator_visible_last_step = int(self.observation.predator_visible)
            self.prey_visible_last_step = int(self.observation.prey_visible)
        self.step_count += 1
        ...
        if not self.model.running or truncated:
            ...
            info = {"captures": self.model.prey_data.puff_count,
                    ...
                    "survived": survived,
                    "agents": {},
                    "prey_visible_last_step": self.prey_visible_last_step,
                    "predator_visible_last_step": self.predator_visible_last_step,
                    "peeking": self.peeking}
